...
@IBDesignable class HBSegmentedControl: UIControl {
    ...
    @IBInspectable var segmentBorderColor : UIColor = UIColor.white {
        didSet {
    ...
    func displayNewSelectedIndex(){
        ...
        UIView.animate(withDuration: 0.35, delay: 0.0, usingSpringWithDamping: 1.0, initialSpringVelocity: 1.0, animations: {
