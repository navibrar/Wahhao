...
private class AKCollectionViewCell: UICollectionViewCell {
	...
	var font = UIFont(name: Constants.SEMI_BOLD_FONT, size: 13)!
	var highlightedFont = UIFont(name: Constants.SEMI_BOLD_FONT, size: 18)!
...
public class AKPickerView: UIView, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, AKCollectionViewLayoutDelegate {
	...
	public lazy var font = UIFont(name: Constants.SEMI_BOLD_FONT, size: 13)!

	/// Readwrite. A font which used in selected cells.
	public lazy var highlightedFont = UIFont(name: Constants.SEMI_BOLD_FONT, size: 18)!
	...
	@IBInspectable public var maskDisabled: Bool = true{
		didSet {
	...
	*/
	fileprivate func sizeForString(_ string: NSString) -> CGSize {
		...
		return CGSize(
			width: ceil(max(size.width, highlightedSize.width)) + 10,
