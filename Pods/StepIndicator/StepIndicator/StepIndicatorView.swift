...
public class StepIndicatorView: UIView {
    ...
    // Variables
    static let defaultColor = #colorLiteral(red: 0, green: 0.5333333333, blue: 1, alpha: 1)
    static let defaultTintColor = #colorLiteral(red: 0, green: 0.5333333333, blue: 1, alpha: 1)
